...
map("v", "J", ":m '>+1<CR>gv=gv", { desc = "Move the highlighted text down", remap = true, silent = true })
map("v", "K", ":m '<-2<CR>gv=gv", { desc = "Move the highlighted text up", remap = true, silent = true })

map("n", "<C-d>", "<C-d>zz", { desc = "Keep cursor in the middle", remap = true })
map("n", "<C-u>", "<C-u>zz", { desc = "Keep cursor in the middle", remap = true })

map("n", "n", "nzzzv", { desc = "Jump to the next occurence of search", remap = true })
map("n", "N", "Nzzzv", { desc = "Jump to the previous occurence of search", remap = true })
